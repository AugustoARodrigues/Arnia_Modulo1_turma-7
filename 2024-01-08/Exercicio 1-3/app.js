...
const condicoesEmPortugues = {
    ...
    // add deixar visivel apos o click do botao a caixa visualiza "conteudo" e outro click volta ao normal
const caixaVisualizar = () => {
    const caixa = document.getElementById('caixa')
    if(caixa.classList.contains('caixa2')){
        caixa.classList.remove('caixa2')
    }else{
        caixa.classList.add('caixa2')
    }
};
